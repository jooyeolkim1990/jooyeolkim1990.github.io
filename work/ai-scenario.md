...
## Why the nuclear analogy is limited
...
## The stronger historical parallels

### 1. Encryption conflicts
...
### 2. DRM and platformized access control
...
## What makes AI more consequential than earlier information technologies
...
- and scalable incorporation into workflows.
...
## Three order scenarios

### Scenario A: API / streaming convergence
...
### Scenario B: encryption-war style diffusion
...
### Scenario C: dual-order stratification
...
- **nuclear-like concentration at the top**
- **internet- and DRM-like diffusion below**
- **continuing struggles over infrastructure bottlenecks, access rights, and deployment control**
...
- platform governance
- managed openness
- diffusion without equality
- post-leak hierarchy formation
