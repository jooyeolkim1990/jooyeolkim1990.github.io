...
- **Moral AI, Gated Access**  
  ...
  [Read](cases/anthropic-moral-ai-gated-access.md)
...
- **When Information Feels Incomplete**  
  ...
  [Read](briefs/ai-governance/when-information-feels-incomplete.md)
...
- [Delegation Without Responsibility](briefs/ai-governance/delegation-without-responsibility.md)  
...
- [Stop–Go Threshold Protocol for Agentic Automation Delegation](tools/agentic-ai/stop-go-threshold-protocol.md)  
  A rule-based protocol for deciding whether an AI system should be granted one more step of delegated authority.

- [Minimal Control Checklist for Execution-Capable AI Agents](tools/agentic-ai/minimal-control-checklist.md)  
  A minimum control gate for reviewing whether execution-capable systems should remain limited, gated, or frozen.

- [Deployment Review Form for Execution-Capable AI Agents](tools/agentic-ai/deployment-review-form.md)  
