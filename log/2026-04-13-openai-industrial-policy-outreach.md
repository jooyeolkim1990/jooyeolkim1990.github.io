...
2. establishing fellowships and focused research grants
3. convening discussions at a new OpenAI Workshop opening in May in Washington, DC

Taken together, this means the public layer is not empty.  
...
- Is the May workshop invite-only, open-application, or hybrid?
- If participation is selective, what are the actual selection criteria?
- Will there be a public agenda, participant list, summary, or post-event write-up?
- How does feedback sent by email connect, if at all, to workshop participation, grant decisions, or later policy influence?
...
- public document
- public rhetoric of democratic input
- public feedback email
- public mention of grants and workshop discussions

But the inner layer is still unclear:
- who gets into the room
- who gets filtered out
- how outside input is used
- what outputs, if any, will later be visible
...
- a visible procedural commitment,
- a traceable selection structure,
- an accountable record,
- or merely a flexible consultation layer.
...
- whether the May workshop is invite-only, open-application, or hybrid
- whether any public selection criteria exist
- whether any public agenda, participant information, summary, or post-event write-up is planned
- how email feedback relates to the workshop itself and to any fellowship, grant, or later policy-discussion process
