...
- aisle entrance warnings;
- ingredient-overlap language;
- driving / drowsiness warnings;
- alcohol / liver-condition warnings;
- counter timing and intervention script.

---

## Example intervention line
...
## Full review can include

A scoped review could include:

- safety UX exposure map;
- aisle-level warning review;
- ingredient-overlap language review;
- pharmacist script audit;
- limited implementation memo.
