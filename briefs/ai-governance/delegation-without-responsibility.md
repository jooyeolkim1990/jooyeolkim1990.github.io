...
## Why visibility mattered before

An earlier device like Google Glass is useful as a contrast.

Whatever else it got wrong, it did not hide its authority very well. It made recording visible. It made engagement legible. People could see when the device was active, who appeared to be using it, and what kind of boundary was being crossed.
Responsibility remained readable enough for public resistance to form.
...
## Why companies cannot solve this alone
...
- unstable definitions of what users were previously allowed to expect
